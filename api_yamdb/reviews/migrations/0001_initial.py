# Generated by Django 3.2 on 2023-04-12 21:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, verbose_name='Ссылка жанра')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(help_text='Категория произведения', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='title', to='reviews.category', verbose_name='Slug категории')),
                ('genre', models.ManyToManyField(help_text='Жанр произведения', related_name='title', to='reviews.Genre', verbose_name='Slug жанра')),
            ],
            options={
